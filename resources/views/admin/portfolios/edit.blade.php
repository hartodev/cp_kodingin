...
<div style="max-width:760px;">
    <div class="card">
        <div class="card-header"><i class="fas fa-edit"></i> Edit Portfolio</div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.2rem;">
                <div class="form-group" style="grid-column:1/-1;">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                        value="{{ old('title', $portfolio->title) }}" placeholder="Judul proyek">
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control">
                        @foreach(['web'=>'Web','mobile'=>'Mobile','design'=>'Design','other'=>'Other'] as $val => $label)
                            <option value="{{ $val }}" {{ old('type', $portfolio->type) === $val ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($portfolio->thumbnail)
                        <img src="{{ asset('storage/'.$portfolio->thumbnail) }}" id="imgPrev"
                            style="width:100%;border-radius:8px;margin-bottom:0.6rem;border:1px solid rgba(244,196,48,0.15);">
                    @else
                        <img id="imgPrev" src="" style="display:none;width:100%;border-radius:8px;margin-bottom:0.6rem;">
                    @endif
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="project_url" class="form-control"
                        value="{{ old('project_url', $portfolio->project_url) }}" placeholder="https://project.com">
                </div>
