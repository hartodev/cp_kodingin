...
<head>
    ...
    <title>Admin Login — PanduanFlow</title>
    ...
    <div class="login-wrapper">
        <div class="login-card">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                            placeholder="admin@panduanflow.com" value="{{ old('email') }}" autocomplete="email"
                            autofocus>
                    </div>
                    @error('email')
            ...
            <div class="login-note">
                <a href="{{ route('admin.dashboard') }}">← Kembali ke website</a>
            </div>
