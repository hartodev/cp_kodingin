...
<head>
    ...
    <title>Reset Password — PanduanFlow Admin</title>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            <div class="login-logo">
                ...
                <p>Buat password baru untuk akun admin kamu</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.password.update') }}">
                ...
                <div class="form-group">
                    ...
                    @error('email') <div class="invalid-feedback"><i class="fas fa-exclamation-circle"></i>
                ...
                <div class="form-group">
                    ...
                    @error('password') <div class="invalid-feedback"><i class="fas fa-exclamation-circle"></i>
                        {{ $message }}</div> @enderror
                </div>
